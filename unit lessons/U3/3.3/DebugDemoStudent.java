...
public class DebugDemoStudent {
    ...
    public static int getFifthElement(int[] arr) {
        ...
        // array can be less than 5 elements
        if (arr.length < 5) {
    ...
    public static int divideNumbers(int a, int b) {
        ...
        if (b == 0) {
            throw new ArithmeticException("you are breaking math");
        }
        return a / b;
    }
    ...
    public static int middleNameLength(String[] names) {
        if (names == null) {
            ...
            throw new IllegalArgumentException("list has to include first middle and last name");
        }
    ...
    public static int squareRootFloor(int n) {
        if (n < 0) {
            throw new ArithmeticException("cannot square root a negative");
        }
    ...
    public static String slice(String word, int start, int end) {
        ...
        if (word.length() < end){
            throw new IllegalArgumentException("cannot have end be greater than string length");
        }else if(start >= end){
            throw new IllegalArgumentException("cannot have start be greater than end");
        }
